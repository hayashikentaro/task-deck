...
export function createTask({
  ...
  codexAppServerParentThreadId = "",
  codexAppServerRootTaskId = "",
  codexAppServerAgentNickname = "",
  codexAppServerAgentRole = "",
  codexAppServerThreadPath = "",
  ...
  return {
    id: String(id || "").trim() || cryptoRandomId(),
    ...
    codexAppServerSessionId: String(codexAppServerSessionId || "").trim(),
    codexAppServerThreadId: String(codexAppServerThreadId || "").trim(),
    codexAppServerParentThreadId: String(codexAppServerParentThreadId || "").trim(),
    codexAppServerRootTaskId: String(codexAppServerRootTaskId || "").trim(),
    codexAppServerAgentNickname: String(codexAppServerAgentNickname || "").trim(),
    codexAppServerAgentRole: String(codexAppServerAgentRole || "").trim(),
    codexAppServerThreadPath: String(codexAppServerThreadPath || "").trim(),
    codexAppServerThreadStatus: String(codexAppServerThreadStatus || "").trim(),
...
export function serializeTask(task) {
  return {
    ...
    codexAppServerSessionId: task.codexAppServerSessionId || "",
    codexAppServerThreadId: task.codexAppServerThreadId || "",
    codexAppServerParentThreadId: task.codexAppServerParentThreadId || "",
    codexAppServerRootTaskId: task.codexAppServerRootTaskId || "",
    codexAppServerAgentNickname: task.codexAppServerAgentNickname || "",
    codexAppServerAgentRole: task.codexAppServerAgentRole || "",
    codexAppServerThreadPath: task.codexAppServerThreadPath || "",
    codexAppServerThreadStatus: task.codexAppServerThreadStatus || "",
