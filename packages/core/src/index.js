...
export function createTask({
  ...
  return {
    ...
    agentSessionDetectedAt,
    agentSessionResumeCommand,
    teamTemplateId: String(teamTemplateId || "").trim(),
    teamId: String(teamId || "").trim(),
    roleId: String(roleId || "").trim(),
    decisionGatewayMode: String(decisionGatewayMode || "").trim(),
    decisionResultHandling: String(decisionResultHandling || "").trim(),
...
export function serializeTask(task) {
  return {
    ...
    teamTemplateId: task.teamTemplateId || "",
    teamId: task.teamId || "",
    roleId: task.roleId || "",
    decisionGatewayMode: task.decisionGatewayMode || "",
    decisionResultHandling: task.decisionResultHandling || "",
